...
class AbilityWidget2 extends StatefulWidget {
  AbilityWidget2({Key key, this.ability}) : super(key: key);
...
class _AbilityWidgetState extends State<AbilityWidget2>
...
class AbilityPainter extends CustomPainter {
  ...
  void drawInfoText2(Canvas canvas)
  {
    ...
    for (int i = 0; i < _data.length; i++) {
      ...
      textPainter.layout();
      Offset offset=Offset(0-(textPainter.width/2), r2 - 0.22 * _r);
